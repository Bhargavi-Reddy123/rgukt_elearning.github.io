...
?>
	<div class="middle">
		<div class="menu">
            ...
            <?php
                $sql2="SELECT distinct(chapter_name) from content where content_course_id='$course_id' and content_class_name ='$class_number' and content_year_number='$year_number' and content_department_name='$course_department_name' ";
                ...
                <?php
                $sql1="SELECT * from content where content_course_id='$course_id' and content_class_name ='$class_number' and content_year_number='$year_number' and content_department_name='$course_department_name' and chapter_name='$chapter_name' ";
                $res2=mysqli_query($conn,$sql1) or die(mysqli_error());
                    if($res2==TRUE)
                    {
                        ...
                        while($rows1=mysqli_fetch_assoc($res2))
                        {
                            ...
                            ?>
                     <div class="smenu">
					<a href="<?php echo $content_link ?>"target='blanck'><?php echo $content_link ?></a>
                    
    
                    <a href="<?php echo SITEURL ; ?>files/<?php echo $_content_file ?>"target='blanck'><?php echo $_content_file ?></a>
